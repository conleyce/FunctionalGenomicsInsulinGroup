...
MyID=aubGroupProjectBloodRnaSeq                        ## Example: MyID=aubrmg001

# Variables: raw data directory (DD), working directory(WD), Quality after cleaning (PCQ), name of file containing the adpaters.
WD=/scratch/$MyID                          ## Example: WD=/scratch/$MyID/PracticeRNAseq
DD=/scratch/$MyID/RawData                          ## Example: DD=/scratch/$MyID/PracticeRNAseq/RawData
CD=/scratch/$MyID/CleanData                          ## Example: CD=/scratch/$MyID/PracticeRNAseq/CleanData
